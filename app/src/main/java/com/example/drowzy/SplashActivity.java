...
// Initialize Firebase Auth
    ...
    private void delaySplashIntent(){
        handler = new Handler();
    ...
    private void googleSignInOptions(){
        ...
        Log.d(TAG, "googleSignInOptions: masuk");
    }

    private void signIn() {
        Intent signInIntent = mGoogleSignInClient.getSignInIntent();
        startActivityForResult(signInIntent, RC_SIGN_IN);
        Log.d(TAG, "signIn: masuk");
    }
...
//                        hideProgressDialog();
    ...
    private void writeNewUser(String userId, String displayName, String email) {
        UserContent user = new UserContent(displayName, email);
