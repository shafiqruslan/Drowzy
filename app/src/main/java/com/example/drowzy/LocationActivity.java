...
//
//    private String url;
//    ArrayList<LocationContent> list;
//    MyAdapter adapter;
...
////
////        query = databaseReference.child("Locations/South Bound");
////
...
//////            getJson(holder,latitude,longitude);
////
...
//////                        holder.post_latitude.setText(String.valueOf(model.getLatitude()));
//////                        holder.post_longitude.setText(String.valueOf(model.getLongitude()));
//////                        holder.post_distance.setText(String.valueOf(result));
//////                        Log.d(TAG, "test: " + result);
//////    //                    Log.d(TAG, "onBindViewHolder: " + model.getName() + " latitude: " + model.getLatitude() + " longitude: " + model.getLongitude() + " result: " + result);
//////                    }
//////                });
////
...
////
////                list = new ArrayList<LocationContent>();
////                for (DataSnapshot postSnapshot: dataSnapshot.getChildren()) {
////                    // TODO: handle the post
////
////                name = postSnapshot.child("name").getValue().toString();
////                data = postSnapshot.child("latitude").getValue().toString();
////                data2 = postSnapshot.child("longitude").getValue().toString();
////
////                dLatitude = Double.valueOf(data);
////                dLongitude = Double.valueOf(data2);
////
////                url ="https://maps.googleapis.com/maps/api/distancematrix/json?units=imperial&origins="+cLatitude+","+cLongitude+"&destinations="+dLatitude+","+dLongitude+"&key="+APIKEY+"\n";
////
////                getJson(new VolleyCallback() {
////                    @Override
////                    public void onSuccess(String result) {
...
////                });
////
////                    Log.d(TAG, "onSuccess: result luar"+mResult);
//////                    LocationContent d = postSnapshot.getValue(LocationContent.class);
//////                    list.add(d);
////                    //list.add(new LocationContent(name,dLatitude,dLongitude,mResult));
////                    list.add(new LocationContent(name,dLatitude,dLongitude,mResult));
//////
//////                    Log.d(TAG, "onDataChange: latitude " + dLatitude);
//////                    Log.d(TAG, "onDataChange: longitude " + dLongitude);
//////                    Log.d(TAG, "onDataChange: url" + url);
////
////                }
////                adapter = new MyAdapter(LocationActivity.this,list);
...
////    }
//
////    private void callData(double latitude, double longitude, final LocationContent model, final LocationViewHolder holder){
////        getJson(new VolleyCallback() {
////            @Override
////            public void onSuccess(String result) {
////                double latitude = model.getLatitude();
...
//////        al.add(new LocationData("shafiq",12,23,10.1));
//////        al.add(new LocationData("alia",12,23,21.2));
//////        al.add(new LocationData("abu",12,23,5.3));
//////        al.add(new LocationData("atan",12,23,48.4));
////
